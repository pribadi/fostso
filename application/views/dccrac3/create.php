                        ...
                        <form role="form">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Date</label>
                                    <input class="form-control datepicker" name="date_dccrac3" type="text" value="<?php echo set_value('date_dccrac3'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Shift</label>
                                ...
                                <div class="form-group">
                                    <label>Time</label>
                                    <input class="form-control timepicker" name="time_dccrac3" type="text" value="<?php echo set_value('time_dccrac3'); ?>">
                                </div>
                                <div class="form-group">
