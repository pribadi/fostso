    ...
    <section class="content-header">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Data Center 4</li>
            </ol>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Data Center 4</h3>
                    </div>
                    <div class="panel-heading">
                        <?php echo form_open('dccrac4/search'); ?>
                        ...
                        <?php echo form_close(); ?>
                        <a href="<?php echo site_url('dccrac4/create'); ?>" class="btn btn-primary" style="float: right;">Add</a>
                        <br/>
                        <br/>
                    </div>
                                ...
                                <tbody>
                                    <?php foreach ($data as $v): ?>
                                        <tr class="odd gradeX" style="text-align: center;">
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('dccrac4/update/' . $v['id']); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> |
                                                <a href="<?php echo site_url('dccrac4/delete/' . $v['id']); ?>" onClick="return doconfirm();"><i class="fa fa-remove" aria-hidden="true" style="color: #d9534f;"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
