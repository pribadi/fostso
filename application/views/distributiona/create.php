                        ...
                        <form role="form">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Date</label>
                                    <input class="form-control datepicker" name="date_distributiona" type="text" value="<?php echo set_value('date_distributiona'); ?>">
                                ...
                                <div class="form-group">
                                    <label>Time</label>
                                    <input class="form-control timepicker" name="time_distributiona" type="text" value="<?php echo set_value('time_distributiona'); ?>">
                                </div>
                                <div class="form-group">
