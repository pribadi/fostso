    ...
    <section class="content-header">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Distribution A</li>
            </ol>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Distribution A</h3>
                    </div>
                    <div class="panel-heading">
                        <?php echo form_open('distributiona/search'); ?>
                        ...
                        <?php echo form_close(); ?>
                        <a href="<?php echo site_url('distributiona/create'); ?>" class="btn btn-primary" style="float: right;">Add</a>
                        <br/>
                        <br/>
                    </div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($data as $v): ?>
                                        <tr class="odd gradeX">
                                            <td><?php echo date("d-M-y", strtotime($v['datetime_distributiona'])); ?></td>
                                            <td><?php echo $v['shift']; ?></td>
                                            <td><?php echo date("H:i", strtotime($v['datetime_distributiona'])); ?></td>
                                            <td><?php echo $v['rs']; ?></td>
                                            <td><?php echo $v['st']; ?></td>
                                            <td><?php echo $v['tr']; ?></td>
                                            <td><?php echo $v['rn']; ?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('distributiona/update/' . $v['id']); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> |
                                                <a href="<?php echo site_url('distributiona/delete/' . $v['id']); ?>" onClick="return doconfirm();"><i class="fa fa-remove" aria-hidden="true" style="color: #d9534f;"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
