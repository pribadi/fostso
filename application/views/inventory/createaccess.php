                        ...
                        <form role="form">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="access_id" value="<?php echo set_value('access_id'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Room Coverage</label>
                                    <input class="form-control" name="room_coverage" value="<?php echo set_value('room_coverage'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Merk</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="ip_address" value="<?php echo set_value('ip_address'); ?>">
                                </div>
                                <div class="form-group">
