                    ...
                    <div class="box-header">
                        ...
                        <form role="form">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    <label>Crac ID</label>
                                    <input class="form-control" name="crac_id" value="<?php echo set_value('crac_id'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Merk</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="model_fan" value="<?php echo set_value('model_fan'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Phase</label>
                                    <input class="form-control" name="phase" value="<?php echo set_value('phase'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Delivery CRAC Vendor</label>
                                    <input class="form-control" name="vendor" value="<?php echo set_value('vendor'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Total Cooling</label>
                                    <input class="form-control" name="total_cooling" value="<?php echo set_value('total_cooling'); ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="sensible_cooling" value="<?php echo set_value('sensible_cooling'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Sensible Capacity</label>
                                    <input class="form-control" name="sensible_capacity" value="<?php echo set_value('sensible_capacity'); ?>">
                                </div>
