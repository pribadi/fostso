                        ...
                        <form role="form">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Date</label>
                                    <input class="form-control datepicker" name="date_mdpa" type="text" value="<?php echo set_value('date_mdpa'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Shift</label>
                                ...
                                <div class="form-group">
                                    <label>Time</label>
                                    <input class="form-control timepicker" name="time_mdpa" type="text" value="<?php echo set_value('time_mdpa'); ?>">
                                </div>
                                <div class="form-group">
