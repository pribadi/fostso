            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <a href="<?php echo site_url('mechanicala/search');?>" class="btn btn-primary" style="float: right;">Back</a>
                        <?php echo form_open(); ?>
                        <form role="form">
                            <div class="box-body">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Date</label>
                                        <input class="form-control datepicker" name="date_mechanicala" type="text" value="<?php echo date('d/m/Y', strtotime($editdata->datetime_mechanicala)); ?>">
                                    ...
                                    <div class="form-group">
                                        <label>Time</label>
                                        <input class="form-control timepicker" name="time_mechanicala" type="text" value="<?php echo date('H:i', strtotime($editdata->datetime_mechanicala)); ?>">
                                        <!-- <p class="help-block">Example block-level help text here.</p> -->
                                    </div>
                                    <div class="form-group">
