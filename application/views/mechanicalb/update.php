                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Date</label>
                                        <input class="form-control datepicker" name="date_mechanicalb" type="text" value="<?php echo date('d/m/Y', strtotime($editdata->datetime_mechanicalb)); ?>">
                                    ...
                                    <div class="form-group">
                                        <label>Time</label>
                                        <input class="form-control timepicker" name="time_mechanicalb" type="text" value="<?php echo date('H:i', strtotime($editdata->datetime_mechanicalb)); ?>">
                                        <!-- <p class="help-block">Example block-level help text here.</p> -->
                                    </div>
                                    <div class="form-group">
