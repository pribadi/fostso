                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Date</label>
                                        <input class="form-control datepicker" name="date_pcoolingtowerb" type="text" value="<?php echo set_value('date_pcoolingtowerb'); ?>">
                                    ...
                                    <div class="form-group">
                                        <label>Time</label>
                                        <input class="form-control timepicker" name="time_pcoolingtowerb" type="text" value="<?php echo set_value('time_pcoolingtowerb'); ?>">
                                    </div>
                                    <div class="form-group">
