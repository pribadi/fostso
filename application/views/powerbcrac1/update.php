                        ...
                        <form role="form">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Date</label>
                                    <input class="form-control datepicker" name="date_powerbcrac1" type="text" value="<?php echo date('d/m/Y', strtotime($editdata->datetime_powerbcrac1)); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Shift</label>
                                ...
                                <div class="form-group">
                                    <label>Time</label>
                                    <input class="form-control timepicker" name="time_powerbcrac1" type="text" value="<?php echo date('H:i', strtotime($editdata->datetime_powerbcrac1)); ?>">
                                </div>
                                <div class="form-group">
