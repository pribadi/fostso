                        ...
                        <form role="form">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Date</label>
                                    <input class="form-control datepicker" name="date_rectifier1" type="text" value="<?php echo set_value('date_rectifier1'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Shift</label>
                                ...
                                <div class="form-group">
                                    <label>Time</label>
                                    <input class="form-control timepicker" name="time_rectifier1" type="text" value="<?php echo set_value('time_rectifier1'); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Load</label>
                                    <input class="form-control" name="load_rectifier1" value="<?php echo set_value('load_rectifier1'); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
