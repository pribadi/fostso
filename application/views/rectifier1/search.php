            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="panel-heading">
                        <?php echo form_open('rectifier1/search'); ?>
                        ...
                        <?php echo form_close(); ?>
                        <a href="<?php echo site_url('rectifier1/create'); ?>" class="btn btn-primary" style="float: right;">Add</a>
                        <br/>
                        <br/>
                    </div>
                                ...
                                <tbody>
                                    <?php foreach ($data as $v): ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('rectifier1/update/' . $v['id']); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> |
                                                <a href="<?php echo site_url('rectifier1/delete/' . $v['id']); ?>" onClick="return doconfirm();"><i class="fa fa-remove" aria-hidden="true" style="color: #d9534f;"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
