    ...
    <section class="content-header">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Rectifier 2</li>
            </ol>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Rectifier 2</h3>
                    </div>
                    <div class="panel-heading">
                        <?php echo form_open('rectifier2/search'); ?>
                        ...
                        <?php echo form_close(); ?>
                        <a href="<?php echo site_url('rectifier2/create'); ?>" class="btn btn-primary" style="float: right;">Add</a>
                        <br/>
                        <br/>
                    </div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($data as $v): ?>
                                        <tr class="odd gradeX">
                                            <td><?php echo date("d-M-y", strtotime($v['datetime_rectifier2'])); ?></td>
                                            <td><?php echo $v['shift']; ?></td>
                                            <td><?php echo date("H:i", strtotime($v['datetime_rectifier2'])); ?></td>
                                            <td><?php echo $v['load_rectifier2']; ?></td>
                                            <td><?php echo $v['voltage']; ?></td>
                                            <td><?php echo $v['accupancy']; ?> %</td>
                                            <td><?php echo $v['autonomi']; ?> Menit</td>
                                            <td><?php echo $v['alarm_condition']; ?></td>
                                            <td><?php echo $v['remark']; ?></td>
                                            <td><?php echo $v['fs_name']; ?></td>
                                            <td>
                                                <a href="<?php echo site_url('rectifier2/update/' . $v['id']); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> |
                                                <a href="<?php echo site_url('rectifier2/delete/' . $v['id']); ?>" onClick="return doconfirm();"><i class="fa fa-remove" aria-hidden="true" style="color: #d9534f;"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
