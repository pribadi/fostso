                        ...
                        <form role="form">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Date</label>
                                    <input class="form-control datepicker" name="date_rectifier3" type="text" value="<?php echo date('d/m/Y', strtotime($editdata->datetime_rectifier3)); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Shift</label>
                                ...
                                <div class="form-group">
                                    <label>Time</label>
                                    <input class="form-control timepicker" name="time_rectifier3" type="text" value="<?php echo date('H:i', strtotime($editdata->datetime_rectifier3)); ?>">
                                </div>
                                <div class="form-group">
                                    <label>Load</label>
                                    <input class="form-control" name="load_rectifier3" value="<?php echo $editdata->load_rectifier3; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
